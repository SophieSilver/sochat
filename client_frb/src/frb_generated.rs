...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1656427399;
...
fn wire__crate__api__service__Service_init_message_stream_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    that: impl CstDecode<
        RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Service>>,
    >,
    message_notification_sink: impl CstDecode<
        StreamSink<(), flutter_rust_bridge::for_generated::DcoCodec>,
    >,
) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::DcoCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "Service_init_message_stream",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            let api_that = that.cst_decode();
            let api_message_notification_sink = message_notification_sink.cst_decode();
            move |context| {
                transform_result_dco::<_, _, ()>((move || {
                    let mut api_that_guard = None;
                    let decode_indices_ =
                    ...
                    let api_that_guard = api_that_guard.unwrap();
                    let output_ok = Result::<_, ()>::Ok({
                        crate::api::service::Service::init_message_stream(
                            &*api_that_guard,
                            api_message_notification_sink,
                        );
                    })?;
                    Ok(output_ok)
                })())
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                for i in decode_indices_ {
                    match i {
                        0 => api_that_guard = Some(api_that.lockable_decode_sync_ref()),
                        1 => api_to_guard = Some(api_to.lockable_decode_sync_ref()),
                        _ => unreachable!(),
                    }
                }
                let api_that_guard = api_that_guard.unwrap();
...
fn wire__crate__api__service__Service_this_id_impl(
    that: impl CstDecode<
        RustOpaqueNom<flutter_rust_bridge::for_generated::RustAutoOpaqueInner<Service>>,
    >,
) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_sync::<flutter_rust_bridge::for_generated::DcoCodec, _>(
        ...
        move || {
            ...
            transform_result_dco::<_, _, ()>((move || {
                ...
                let api_that_guard = api_that_guard.unwrap();
                let output_ok =
                    Result::<_, ()>::Ok(crate::api::service::Service::this_id(&*api_that_guard))?;
                Ok(output_ok)
            })())
        },
    )
...
mod io {
    ...
    impl CstDecode<StreamSink<(), flutter_rust_bridge::for_generated::DcoCodec>>
        for *mut wire_cst_list_prim_u_8_strict
    {
        // Codec=Cst (C-struct based), see doc to use other codecs
    ...
    #[no_mangle]
    pub extern "C" fn frbgen_client_wire__crate__api__service__Service_init_message_stream(
        port_: i64,
        that: usize,
        message_notification_sink: *mut wire_cst_list_prim_u_8_strict,
    ) {
        wire__crate__api__service__Service_init_message_stream_impl(
            port_,
            that,
    ...
    pub extern "C" fn frbgen_client_wire__crate__api__service__Service_send_message(
        ...
        wire__crate__api__service__Service_send_message_impl(that, to, message)
    }

    #[no_mangle]
    pub extern "C" fn frbgen_client_wire__crate__api__service__Service_this_id(
        that: usize,
    ) -> flutter_rust_bridge::for_generated::WireSyncRust2DartDco {
        wire__crate__api__service__Service_this_id_impl(that)
    }
